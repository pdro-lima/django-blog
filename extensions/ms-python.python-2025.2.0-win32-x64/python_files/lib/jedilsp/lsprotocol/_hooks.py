...
def _register_capabilities_hooks(converter: cattrs.Converter) -> cattrs.Converter:
    ...
    def _notebook_document_sync_hook(object_: Any, _: type) -> Optional[
        Union[
    ...
    def _declaration_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _type_definition_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _implementation_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _color_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _folding_range_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _selection_range_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _call_hierarchy_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _linked_editing_range_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _semantic_tokens_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _moniker_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _type_hierarchy_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _inline_value_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _inlay_hint_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _diagnostic_provider_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _location_hook(object_: Any, _: type) -> Optional[
        Union[
            lsp_types.Location,
    ...
    def _markup_content_hook(object_: Any, _: type) -> Optional[
        Union[
            OptionalPrimitive,
    ...
    def _document_edit_hook(object_: Any, _: type) -> Optional[
        Union[
    ...
    def _semantic_tokens_capabilities_hook(object_: Any, _: type) -> Union[
        OptionalPrimitive,
    ...
    def _notebook_sync_option_selector_hook(object_: Any, _: type) -> Union[
...
def _register_required_structure_hooks(
    ...
    def _text_document_filter_hook(object_: Any, _: type) -> Union[
        str,
    ...
    def _notebook_filter_hook(object_: Any, _: type) -> Union[
        str,
