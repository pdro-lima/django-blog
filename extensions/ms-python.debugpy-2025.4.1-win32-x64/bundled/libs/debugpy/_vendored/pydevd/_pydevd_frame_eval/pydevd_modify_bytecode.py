...
from _pydevd_frame_eval.pydevd_frame_tracing import (
    _pydev_stop_at_break,
    _pydev_needs_stop_at_break,
)
        ...
        while curr_node is not None:
            ...
            if FIX_PREDICT:
                ...
                if predict_targets:
                    ...
                    if next_name in predict_targets:
                        next_instruction_lineno = getattr(
            ...
            if instruction_lineno is not None:
                ...
                if instruction_lineno in modified_breakpoint_lines:
                    ...
                    if (
                        curr_node.prev is not None
                        and curr_node.prev.data.__class__ == Label
