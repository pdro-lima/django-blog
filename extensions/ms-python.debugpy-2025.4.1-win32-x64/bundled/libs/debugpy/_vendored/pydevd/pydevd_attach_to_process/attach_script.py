...
def fix_main_thread_id(
    ...
    on_exception=lambda msg: None,
    on_critical=lambda msg: None,
):
        ...
        with threading._active_limbo_lock:
            ...
            if main_thread_id is not None:
                ...
                if main_thread_id != getattr(main_thread_instance, main_thread_id_attr):
                    ...
                    threading._active.pop(
                        getattr(main_thread_instance, main_thread_id_attr), None
                    )
                    setattr(main_thread_instance, main_thread_id_attr, main_thread_id)
                    threading._active[
                        getattr(main_thread_instance, main_thread_id_attr)
                    ] = main_thread_instance
